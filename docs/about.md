<div class="about-header">
  ...
  <a href="https://scholar.google.com/citations?user=wJ86HJYAAAAJ" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://github.com/quintendewettinck" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://www.linkedin.com/in/quinten-de-wettinck/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <!-- mailto:quinten.dewettinck@gmail.com -->
  <a href="mailto:quinten.dewettinck@kuleuven.be" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
I am a PhD candidate in Business Economics at KU Leuven under supervision of Prof. Karolien De Bruyne (KU Leuven, Belgium) and Prof. Wouter Bam (UBC, Canada). I hold master's degrees in Statistics & Data Science and in Business Administration, both from KU Leuven. My doctoral research focuses on **economic complexity theory**, **trade diversification** and **sustainable development**.
...
<!-- With my work, I aim to: (1) advance our scientific understanding of how economies can develop in alignment with sustainability objectives, and (2) provide evidence-based support to industrial policy makers seeking to promote sustainable growth. -->